...
<!-- Footer -->
 <div class="footer">
    ...
    <div class="contenedor_footer">
        <div class="logos">
            <img src="assets/img/webAnitaLogo.png" alt="Logo">
        </div>
        <div class="menufooter">
            <ul>
                <li><a href="/nutriologaWeb/index.php">Inicio</a></li>
                <li><a href="/nutriologaWeb/html/paginas/about.php">Sobre Mí</a></li>
                <li><a href="/nutriologaWeb/html/paginas/services.php">Consultas Nutricionales</a></li>
                <li><a href="/nutriologaWeb/html/paginas/recipes.php">Recetario</a></li>
            </ul>
        </div> 
    </div>
 </div>
